  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  return (
    <div style={{ fontFamily: "'Nunito','Segoe UI',sans-serif", background: "#f4f8ed", minHeight: "100vh", paddingBottom: 48 }}>
      ...
      {/* Header */}
      <div style={{ background: "#fff", padding: "16px 32px", display: "flex", alignItems: "center", gap: 14, marginBottom: 28, borderBottom: "2px solid #9abb5d" }}>
        <img src={`data:image/png;base64,${LOGO_B64}`} alt="Espaço CEL" style={{ height: 52, width: "auto" }} />
        <div>
          <div style={{ fontWeight: 800, fontSize: 20, color: "#3d6b10", letterSpacing: -0.5 }}>Gerador de Orçamento</div>
          <div style={{ fontSize: 11, color: "#888", marginTop: 1 }}>Espaço CEL · Tabela de Preços 2026</div>
        </div>
        <div style={{ marginLeft: "auto", textAlign: "right" }}>
          <div style={{ fontSize: 11, color: "#aaa" }}>Valores Reajustados</div>
          <div style={{ fontSize: 13, color: "#3d6b10", fontWeight: 600 }}>2026</div>
        </div>
      </div>
